...
Configure()
{
    ...
    addPurchaseRequirement(level.weapons_ak47, "sig_mp", 250);
	...
	addPurchaseRequirement(level.weapons_p90, "sig_mp", 250);
	...
	addPurchaseRequirement(level.weapons_model_1887, "winchester_mp", 250);
