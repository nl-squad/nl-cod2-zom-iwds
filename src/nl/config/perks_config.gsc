Configure()
{
	...
	blanco\config::addNewPerk(23, "tactical", "Precision Fire", 164, "nl_hudd_pe23", "Increases Money for Kills with Semi-Auto by 40 percent");
	blanco\config::addNewPerk(5, "tactical", "Rich", 184, "nl_hud_pe22", "Increases Money for Kills with Weapons by 30 percent");
	blanco\config::addNewPerk(24, "tactical", "Heavy Fire", 204, "nl_hudd_pe24", "Increases Money for Kills with LMG by 40 percent");
