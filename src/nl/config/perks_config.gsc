Configure()
{
    ...
    level.PERK_jumpySpawnLabel = &"^3Jumpy Spawn^9: ";
    level.PERK_potatoLabel = &"^3Potato^9: ";
    level.PERK_nadeLabel = &"^3Zombie Nade^9: ";
    level.PERK_highJumpLabel = &"^3High Jump^9: ";
    level.PERK_toxicLabel = &"^3Toxic^9: ";
    level.PERK_mutantLabel = &"^3Mutant^9: ";
    level.PERK_heavyMutantLabel = &"^3Heavy Mutant^9: ";
    level.PERK_armouredLabel = &"^3Armoured^9: ";
	level.PERK_antiInviNadesLabel = &"^3Anti-Invi Nades^9: ";
    level.PERK_bulletDodgeLabel = &"^3Bullet Dodge^9: ";
    level.PERK_swooshLabel = &"^3Swoosh Jump^9: ";
    level.PERK_toxicAuraLabel = &"^3Toxic Aura^9: ";
    level.PERK_absorptionLabel = &"^3Absorption^9: ";
	...
	blanco\config::addNewPerk(8, "combat", "Escape", 112, "nl_hud_pe9", "Provides 10 seconds of Spawn Protection");
	...
	blanco\config::addNewPerk(20, "combat", "Random Combat", 272, "nl_hud_pe20", "Selects a random Combat Perk");
}
