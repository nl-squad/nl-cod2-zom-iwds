Main()
{
    ...
    blanco\config::addNewKillstreak(12, "Sentry Gun", 40, 18, "nl_hud_kr14", "Plantable Sentry Gun for 40 seconds", "Sentry ^9Gun ^4: ^9Plant ^4[^7" + key + "^4]", blanco\actions\sentry_gun::Activate, blanco\actions\sentry_gun::CanUse, blanco\utils::a(40));
