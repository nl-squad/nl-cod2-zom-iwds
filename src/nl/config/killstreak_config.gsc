Configure()
{
    ...
    blanco\config::addNewKillstreak(4, "Mortar", 20, 25, 30, 15, "nl_hud_kr13", "Mortar Barrage called by using Binoculars", "^7Mor^9tar ^4: ^9Activate ^4[^7" + key + "^4]", blanco\actions\mortar::Activate, blanco\actions\mortar::CanUse);
    blanco\config::addNewKillstreak(11, "Rambo Mode", 25, 30, 35, 20, "nl_hud_kr15", "Unlimited Magazine for 20 seconds & 3 Grenades", "Rambo ^9Mode ^4: ^9Activate ^4[^7" + key + "^4]", blanco\actions\rambo::Activate, blanco\actions\rambo::CanUse, blanco\utils::a(20));
    blanco\config::addNewKillstreak(12, "Sentry Gun", 30, 35, 40, 25, "nl_hud_kr14", "Plantable Sentry Gun for 30 seconds", "Sentry ^9Gun ^4: ^9Plant ^4[^7" + key + "^4]", blanco\actions\sentry_gun::Activate, blanco\actions\sentry_gun::CanUse, blanco\utils::a(30));
	blanco\config::addNewKillstreak(14, "Rocket", 35, 40, 50, 30, "nl_hud_kr17", "Quake3 Rocket Launcher with 10 Missiles", "Roc^9ket ^4: ^9Get ^4[^7" + key + "^4]", blanco\modules\weapons::GiveRocket);
    blanco\config::addNewKillstreak(10, "Grenade Launcher", 40, 50, 75, 35, "nl_hud_kr11", "Grenade Launcher with 18 Grenades", "Grenade ^9Launcher ^4: ^9Get ^4[^7" + key + "^4]", blanco\modules\weapons::GiveLauncher);
    // blanco\config::addNewKillstreak(13, "EMP", 40, 50, 75, 35, "nl_hud_kr16", "Disables Zombie Shop & Deathstreaks for 20 seconds", "E^9MP ^4: ^9Activate ^4[^7" + key + "^4]", blanco\actions\emp::Activate, blanco\actions\emp::CanUse, a(20));
    blanco\config::addNewKillstreak(13, "Raptor", 50, 75, 100, 40, "nl_hud_kr21", "Ground Combat Drone protects Owner for 25 seconds", "Rap^9tor ^4: ^9Activate ^4[^7" + key + "^4]", blanco\actions\raptor::Activate, blanco\actions\raptor::CanUse);
    blanco\config::addNewKillstreak(15, "Nuke", 150, 200, 250, 50, "nl_hud_kr18", "Nuke ends the Map, adding a +500 Score Bonus", "Nu^9ke ^4: ^9Activate ^4[^7" + key + "^4]", blanco\actions\nuke::Activate, blanco\actions\nuke::CanUse);
