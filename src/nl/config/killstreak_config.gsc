Configure()
{
	...
	blanco\config::addNewKillstreak(8, "Ammo Pack", 18, 20, 25, 12, "nl_hud_kr4", "Gives the Weapons Max Ammo & 3 Grenades", "Ammo ^9Pack ^4: ^9Get ^4[^7" + key + "^4]", blanco\actions\weapons::Ammo);
