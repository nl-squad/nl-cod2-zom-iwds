Configure()
{
	...
	blanco\config::addNewKillstreak(7, "browning_mg", "Browning MG", 10, 12, 15, 5, "nl_hud_kr5", "Plantable Machine Gun for 40 seconds", "Brow^9ning ^7MG ^4: ^9Plant ^4[^7" + key + "^4]", blanco\actions\browning::Activate, blanco\actions\browning::CanUse, blanco\utils::a(40));
	blanco\config::addNewKillstreak(9, "thunderclaps", "Thunderclaps", 12, 15, 18, 8, "hud_thunder", "Summons a Thunderstorm that kills Zombies", "Thunder^9claps ^4: ^9Activate ^4[^7" + key + "^4]", blanco\actions\thunderclaps::ActivateWithChallangeProgress, blanco\actions\thunderclaps::CanUse);
	...
	blanco\config::addNewKillstreak(8, "ammo_pack", "Ammo Pack", 18, 20, 25, 12, "nl_hud_kr4", "Gives the Weapons Max Ammo & 3 Grenades", "Ammo ^9Pack ^4: ^9Get ^4[^7" + key + "^4]", blanco\modules\weapons::GiveAmmo);
    ...
    blanco\config::addNewKillstreak(11, "rambo_mode", "Rambo Mode", 25, 30, 35, 20, "nl_hud_kr15", "Unlimited Magazine for 20 seconds & 3 Grenades", "Rambo ^9Mode ^4: ^9Activate ^4[^7" + key + "^4]", blanco\actions\rambo::Activate, blanco\actions\rambo::CanUse, blanco\utils::a(20));
    blanco\config::addNewKillstreak(12, "sentry_gun", "Sentry Gun", 30, 35, 40, 25, "nl_hud_kr14", "Plantable Sentry Gun for 30 seconds", "Sentry ^9Gun ^4: ^9Plant ^4[^7" + key + "^4]", blanco\actions\sentry_gun::Activate, blanco\actions\sentry_gun::CanUse, blanco\utils::a(30));
    ...
    blanco\config::addNewKillstreak(10, "grenade_launcher", "Grenade Launcher", 40, 50, 75, 35, "nl_hud_kr11", "Grenade Launcher with 18 Grenades", "Grenade ^9Launcher ^4: ^9Get ^4[^7" + key + "^4]", blanco\modules\weapons::GiveLauncher);
