Configure()
{
	...
	blanco\config::addNewKillstreak(7, "browning", "Browning MG", 12, 15, 18, 8, "nl_hud_kr5", "Plantable Machine Gun for 40 seconds", "Browning MG^4: ^9Plant ^4[^7" + key + "^4]", blanco\actions\browning::Activate, blanco\actions\browning::CanUse, blanco\utils::a(40));
