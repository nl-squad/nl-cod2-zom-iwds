Main()
{
    ...
    blanco\config::addNewKillstreak(12, "Defense Cannon", 40, 18, "nl_hud_kr5", "Plantable Sentry Gun for 40 seconds", "Sentry ^9Gun ^4: ^9Plant ^4[^7" + key + "^4]", blanco\actions\defense_cannon::Activate, blanco\actions\defense_cannon::CanUse, blanco\utils::a(40));
