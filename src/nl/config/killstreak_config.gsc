Configure()
{
    ...
    blanco\config::addNewKillstreak(11, "Rambo Mode", 25, 30, 35, 16, "nl_hud_kr15", "Double Weapon Damage & Unlimited Magazine for 30 seconds", "Rambo ^9Mode ^4: ^9Activate ^4[^7" + key + "^4]", blanco\actions\rambo::ActivateWithChallangeProgress, blanco\actions\rambo::CanUse, blanco\utils::a(30));
