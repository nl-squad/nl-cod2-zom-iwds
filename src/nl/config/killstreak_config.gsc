Configure()
{
    ...
    blanco\config::addNewKillstreak(6, "Big Grenade", 8, 10, 12, 3, "nl_hud_kr8", "Grenade with high Damage Radius", "Big ^9Grenade ^4: ^9Get ^4[^7" + key + "^4]", blanco\modules\weapons::GiveBigNade);
    ...
    blanco\config::addNewKillstreak(10, "Grenade Launcher", 35, 40, 50, 20, "nl_hud_kr11", "Grenade Launcher with 15 Grenades", "Grenade ^9Launcher ^4: ^9Get ^4[^7" + key + "^4]", blanco\modules\weapons::GiveLauncher);
    ...
    blanco\config::addNewKillstreak(14, "Rocket", 40, 50, 75, 22, "nl_hud_kr17", "Quake3 Rocket Launcher with 10 Missiles", "Roc^9ket ^4: ^9Get ^4[^7" + key + "^4]", blanco\modules\weapons::GiveRocket);
