Configure()
{
    ...
    blanco\config::addNewKillstreak(10, "Grenade Launcher", 40, 50, 75, 35, "nl_hud_kr11", "Grenade Launcher with 24 Grenades", "Grenade ^9Launcher ^4: ^9Get ^4[^7" + key + "^4]", blanco\modules\weapons::GiveLauncher);
