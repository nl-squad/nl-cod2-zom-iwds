Main()
{
    ...
    blanco\config::addNewKillstreak(9, "Thunderclaps", 30, 14, "hud_thunder", "Summons Thunderstorm killing zombies", "Thunder^9claps ^4: ^9Activate ^4[^7" + key + "^4]", blanco\actions\thunderclaps::ActivateWithChallangeProgress, blanco\actions\thunderclaps::CanUse);
    ...
    blanco\config::addNewKillstreak(15, "Nuke", 200, 30, "nl_hud_kr18", "Ends the current map and get +500 score bonus", "Nu^9ke ^4: ^9Drop ^4[^7" + key + "^4]", blanco\actions\nuke::Activate, blanco\actions\nuke::CanUse);
