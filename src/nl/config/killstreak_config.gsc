Configure()
{
    ...
    blanco\config::addNewKillstreak(1, "artillery", "Artillery", 8, 10, 12, 3, "nl_hud_kr3", "Artillery Barrage called by using Binoculars", "Artillery^4: ^9Activate ^4[^7" + key + "^4]", blanco\actions\artillery::Activate, blanco\actions\artillery::CanUse);
	 blanco\config::addNewKillstreak(5, "napalm", "Napalm", 10, 12, 15, 5, "nl_hud_kr7", "Napalm Strike called by using Binoculars", "Napalm^4: ^9Activate ^4[^7" + key + "^4]", blanco\actions\napalm::Activate, blanco\actions\napalm::CanUse);
	blanco\config::addNewKillstreak(7, "browning", "Browning MG", 12, 15, 18, 8, "nl_hud_kr5", "Plantable Machine Gun for 30 seconds", "Browning MG^4: ^9Plant ^4[^7" + key + "^4]", blanco\actions\browning::Activate, blanco\actions\browning::CanUse, blanco\utils::a(30));
	blanco\config::addNewKillstreak(9, "thunder", "Thunderclaps", 15, 18, 20, 10, "hud_thunder", "Summons a Thunderstorm that kills Zombies", "Thunderclaps^4: ^9Activate ^4[^7" + key + "^4]", blanco\actions\thunderclaps::ActivateWithChallangeProgress, blanco\actions\thunderclaps::CanUse);
    ...
    blanco\config::addNewKillstreak(15, "nuke", "Nuke", 150, 200, 250, 50, "nl_hud_kr18", "Nuke ends the Map & grants a +20 percent Score Bonus", "Nuke^4: ^9Activate ^4[^7" + key + "^4]", blanco\actions\nuke::Activate, blanco\actions\nuke::CanUse);
    ...
    blanco\config::addNewKillstreak(19, "rage", "Rage", 9999, 9999, 9999, 999, "hud_rage", "Double Damage and Ability to Burn for 45 seconds", "Rage Mode^4: ^9Activate ^4[^7" + key + "^4]", blanco\actions\rage::Activate, blanco\actions\rage::CanUse, blanco\utils::a(45));
