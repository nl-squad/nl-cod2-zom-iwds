Configure()
{
    ...
    // blanco\config::addNewKillstreak(13, "EMP", 40, 50, 75, 30, "nl_hud_kr16", "Disables Zombie Shop & Deathstreaks for 20 seconds", "E^9MP ^4: ^9Activate ^4[^7" + key + "^4]", blanco\actions\emp::Activate, blanco\actions\emp::CanUse, a(20));
