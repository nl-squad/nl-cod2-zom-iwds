Configure()
{
    ...
    level.DEATHSTREAK_absorptionHp = 2137;
    level.DEATHSTREAK_absorptionMaxHealth = 400;
	level.DEATHSTREAK_absorptionGrade1RadiusSquared = 96 * 96;
    level.DEATHSTREAK_absorptionGrade1TickDamage = 20;
    level.DEATHSTREAK_absorptionGrade2RadiusSquared = 128 * 120;
    level.DEATHSTREAK_absorptionGrade2TickDamage = 20;
    ...
    s = stage(20, &"^7Zom^9bie ^7Pow^9er^9: ^8Strong^9, ^7Ne^9xt ^7In^4: ^7");
    ...
    s = stage(30, &"^7Zom^9bie ^7Pow^9er^9: ^1Brutal^9, ^7Ne^9xt ^7In^4: ^7");
    reward(s, 0, nothing, 1);
    reward(s, 0, speed, 1);
	reward(s, 15, speed, 2);
	reward(s, 10, speed, 3);
    ...
    s = stage(40, &"^7Zom^9bie ^7Pow^9er^9: ^6Unstoppable");
    reward(s, 0, nothing, 1);
    reward(s, 0, speed, 1);
	reward(s, 0, speed, 2);
	reward(s, 20, speed, 3);
	...
	reward(s, 5, heavyMutant, 2);
	reward(s, 15, heavyMutant, 3);
    reward(s, 0, armoured, 1);
	reward(s, 10, armoured, 2);
	reward(s, 5, armoured, 3);
    reward(s, 0, highJump, 1);
	reward(s, 10, highJump, 2);
	reward(s, 5, highJump, 3);
	reward(s, 0, bulletDodge, 1);
	reward(s, 0, bulletDodge, 2);
	reward(s, 15, bulletDodge, 3);
    reward(s, 0, jumpySpawn, 1);
	reward(s, 0, jumpySpawn, 2);
	reward(s, 15, jumpySpawn, 3);
    reward(s, 0, swoosh, 1);
	reward(s, 0, swoosh, 2);
