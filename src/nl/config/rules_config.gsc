...
{
    level.rules = [];
    blanco\modules\server_rules::addRule("Cheats/Macro = Ban", a("hax", "cheat", "cheats", "hack", "hacks", "wh", "aimbot", "macro", "norecoil", "mombot", "trigger bot")); 
	...
	blanco\modules\server_rules::addRule("Do not team up with the enemy team.", a("farm", "team up", "team play", "farming")); 
