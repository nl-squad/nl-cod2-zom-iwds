...
Configure()
{
	...
	tips[tips.size] = "You can see your Hunters Killed in the bottom right corner";
    ...
    tips[tips.size] = "You can access the Hunters or VIP Menu by pressing ^3V ^7button";
    ...
    tips[tips.size] = "Remember to save your Loadout Class after every change";
	...
	tips[tips.size] = "Speed Zombie = Fast movement, but only 200 HP";
	tips[tips.size] = "Mutant = Reduced Fire & Explosion damage, 550-650 HP";
	tips[tips.size] = "Heavy Mutant = Reduced Fire & Explosion damage, 750-850 HP";
	...
	tips[tips.size] = "VIP Shop item prices increase by 20 percent with each purchase";
	...
	tips[tips.size] = "You can check all Zombie types in the Loadout Menu -> Zombie Profile";
	...
	tips[tips.size] = "You will receive ^8nL Tokens ^7& ^3EXP ^7after each map";
	...
	tips[tips.size] = "^8Patron ^7includes ^3VIP^7 status";
