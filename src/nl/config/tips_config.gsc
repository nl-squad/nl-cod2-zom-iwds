...
Main()
{
    ...
    tips[tips.size] = "You can access the Hunters and Zombies shops by pressing ^3V ^7button";
	...
	tips[tips.size] = "^3Patron ^7includes ^3VIP ^7status";
	tips[tips.size] = "Do not be toxic, it's just a game from 2005";
