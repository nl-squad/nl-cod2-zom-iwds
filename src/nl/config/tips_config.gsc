...
Configure()
{
	...
	tips[tips.size] = "Wunderwaffe is only available from the MysteryBox";
	tips[tips.size] = "Crossbow is exclusive to Server Patrons";
	...
	tips[tips.size] = "All Mutants receive less damage from Explosions & Fire";
	tips[tips.size] = "Skeleton = Dodge Bullets Ability, 300 HP";
	tips[tips.size] = "Red Half-Life Zombie = Jumpy Spawn Ability, 300 HP";
